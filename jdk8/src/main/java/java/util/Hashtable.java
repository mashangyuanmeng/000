...
/**
 * <pre>
 *     Hashtable，线程安全，key不允许存在null，默认大小为 11，每次自增都是乘 2+1，保证大小为奇数;
 *     所有对外的方法都使用了 synchronized 修饰
 * </pre>
...
public class Hashtable<K,V>
    ...
    /**
     * 自增因子为 0.75，与 HashMap 不同的是，Hashatble 的默认大小为 11；
     */
    public Hashtable() {
        this(11, 0.75f);
    }
